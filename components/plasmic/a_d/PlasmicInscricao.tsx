                        ...
                        try {
                          return $state.selectedIndex !== undefined
                            ...
                            ? {
                                ...
                                complemento: $state.inscritos[0].complemento,
                                              ...
                                              try {
                                                return currentItem.key ===
                                                  ...
                                                  ? `${
                                                      ...
                                                      currentPerson.address
                                                        .complemento
                                                        ? ` (${currentPerson.address.complemento})`
                                                        : ""
                                                    }, ${
                                                      currentPerson.address
                                                        .bairro
                                ...
                                try {
                                  return (() => {
                                    ...
                                    const adultos = $state.inscritos.filter(
                                      person =>
                                        calculateAge(person.birthdate) > 12
                                    ).length;
                                    const criancas =
                                      $state.inscritos.length - adultos;
                                    return {
                                      adultos,
                                      criancas
                                    };
                              ...
                              >
                                <React.Fragment>
                                  {(() => {
                                    try {
                                      return `Total: R$ ${(
                                        $ctx.ageFn.adultos * 145 +
                                        $ctx.ageFn.criancas * 60
                                      ).toLocaleString("fr", {
                                      ...
                                      dataOp: __wrapUserFunction(
                                        {
                                          ...
                                          interactionUuid: "59g5bhNEc",
                                          componentUuid: "dYFvLDGEBe",
                                          argName: "dataOp"
                                        },
                                        () => ({
                                          sourceId: "du8jW5s7JnVfk4bHYp38RF",
                                          opId: "2f252355-d12d-4d09-9ec5-754206a83ab9",
                                          userArgs: {
                                            variables: [$state.inscritos[0]]
                                          },
                                          cacheKey: null,
                                          invalidatedKeys: [],
                                          roleId: null
