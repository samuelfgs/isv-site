...
import sty from "../a_d_5/PlasmicSelect__OptionGroup.module.css"; // plasmic-import: NI0AWzMMpBP/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uqTi4)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mp9Jj)}
              />
            </React.Fragment>
          ),
